...
avgRR_LCW = avgUserProfile(2);
avgHR_HCW = avgUserProfile(5);
avgRR_HCW = avgUserProfile(6);
avgHR_LCW_std = avgUserProfile(3);
avgRR_LCW_std = avgUserProfile(4);
avgHR_HCW_std = avgUserProfile(7);
...
disp(['Average HR (LCW): ', num2str(avgHR_LCW_std)]);
disp(['Average RR (LCW): ', num2str(avgRR_LCW_std)]);
disp(['Average HR (HCW): ', num2str(avgHR_HCW_std)]);
disp(['Average RR (HCW): ', num2str(avgRR_HCW_std)]);
